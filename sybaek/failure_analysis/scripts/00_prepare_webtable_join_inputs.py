...
from sybaek.failure_analysis.src.config import ensure_parent, load_config, parse_args, resolve_path


RAW_ROOT = "sybaek/failure_analysis/artifacts/raw/webtable_join"
...
EXTRACTED_ROOT = f"{RAW_ROOT}/datasets/extracted_selected"
SUMMARY_FILE = "sybaek/failure_analysis/results/webtable_join_prepare_summary.csv"
